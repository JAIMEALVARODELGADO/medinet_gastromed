				...
				<div class="card">
					...
					<div class="card" id="divantecedentes">
						...
						<div class="form-group row">
							<label class="col-sm-12 col-form-label">Personales
								<textarea rows="7" class="form-control" id="personales_ante" name="personales_ante" maxlength='2500' placeholder="Antecedentes patológicos, quirurgicos, traumaticos, toxicoalérgicos, etc" required><?php echo $personales_ante;?></textarea>
							</label>
						</div>

						<div class="form-group row">
							<label class="col-sm-12 col-form-label">Familiares
								<textarea rows="7" class="form-control" id="familiares_ante" name="familiares_ante" maxlength='2500' placeholder="Antecedentes familiares" required><?php echo $familiares_ante;?></textarea>
							</label>
						</div>
					</div>
					<?php
					...
					<div class="card">
						...
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<textarea rows="3" class="form-control" id="plan_con" name="plan_con" maxlength='2500' placeholder="Plan de Manejo" required><?php echo $plan_con;?></textarea>
							</div>                                    
						</div>
						<div class="form-group row">
